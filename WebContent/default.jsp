   ...
   <div class="header">
     <div class="for-sticky">
       ...
       <div class="col-md-2 col-xs-6 logo">
         <img alt="logo" class="logo-nav" src="images/biglogo.png">
       </div>
       <!--/.LOGO END-->
     </div>
     <div class="menu-wrap">
...
<form action="Home" method="post" style="width: 494px; margin-left: 100px">
	...
	<input type="button" value="Clear all" onclick="clearContents();" style="width: 100px;">
  			 ...
  			 <div style="float: right; height: 432px;width: 468px;width: 468px; margin-right: 150px; position: relative; top: 30px;">
  			 
			<section id="contact" class="white-bg" style="height: 452px;width: 468px;width: 468px;padding-left: 20px;">
          <div class="container">
            <div class="row">		
            	<textarea disabled id="txtarea" name="Text" cols="60" rows="1" style="width: 468px; height: 220px;" readonly></textarea>
			<!-- This is the HTML Part -->
			
			<form method="get" action="Security" style="width: 291px; ">
			    <input type="submit" value="Forgotten password or login?">
			</form>
			<form method="get" action="Registration" style="width: 132px; ">
			    <input type="submit" value="Registration">
			</form><form method="get" action="Login" style="width: 79px; ">
