...
<div id="preloader">
   ...
   <div class="content-wrap">
      <!--CONTENT-->
      <div class="content">
   <form action="Registration" method ="post" id="home">
          <div class="container">
            <div class="row">
              <div class="wrap-hero-content">
                  <div class="hero-content">
                    ...
                    <section id="contact" class="white-bg">
	                    <div class="container">
            			<div class="row">
							<font color=red>${Errors.nameErr}</font>
							User name: <input type="text" name="name" style = "margin-right: 32px; text-transform: none"><br><br>
							<font color=red>${Errors.loginErr}</font>
							Login: <input type="text" name="login" style = "text-transform: none"><br><br>
							<font color=red>${Errors.EmailErr}</font>
							Email: <input type="text" name="email" style = "text-transform: none"><br><br>
							<font color=red>${Errors.passwordErr}</font>
							Password : <input type="password" name="password" style = "margin-right: 33px; text-transform: none"><br><br>
